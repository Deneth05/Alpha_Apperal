        ...
        <div className='button-container'>
          ...
          <Link to='/customers/create'>
            <button className='button buttonAddNew'>
              <img src='../public/add.png' className='icon' alt='Add' /> Add New Customer
            </button>
          </Link>
          <Link to='/orders/home'>
            <button className='button buttonSizes'>
              <img src='../public/order.png' className='icon' alt='Sizes' /> Place an order
            </button>
          </Link>
          <Link to='/items/create'>
            <button className='button buttonSizes'>
              <img src='../public/order.png' className='icon' alt='Sizes' /> List an item
            </button>
          </Link>
          <button
            onClick={generatePDF}
