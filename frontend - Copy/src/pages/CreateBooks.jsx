...
const CreateBooks = () => {
  ...
  const [unit, setUnit] = useState(''); // Default unit is empty for "Select Unit"
  ...
  useEffect(() => {
    ...
    axios.get(`http://localhost:5555/inventory/${routeItemCode}`)
      .then((response) => {
        const { itemCode, productName, productCategory, Quantity, unit, price } = response.data;
  ...
  const handleUpdateBook = () => {
    const data = {
      itemCode,
      productName,
      productCategory: productCategory === 'Other' ? customCategory : productCategory, // Use custom category if "Other" is selected
    ...
    <div className="flex">
      ...
      <div className="main-content">
        ...
        <div className='p-4'>
          ...
          <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto bg-gray-100'>
            <div className='my-4'>
