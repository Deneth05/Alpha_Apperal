        ...
        <div className='button-container'>
          ...
          <Link to='/inventory/create'>
            <button className='button buttonAddNew'>
              <img src='../public/add.png' className='icon' alt='Add' /> Add New Item
            </button>
          </Link>
          <button
            onClick={generatePDF}
          ...
          >
            <span className='icon'><img src='/pdf.png' alt="PDF" /></span> Generate Report (PDF)
          </button>
        </div>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th className='table-heading max-md:hidden'>Quantity (Unit)</th> {/* Updated header */}
