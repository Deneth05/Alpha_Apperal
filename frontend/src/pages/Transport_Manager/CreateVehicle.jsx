...
const CreateVehicle = () => {
    ...
    const validateDescription = (text) => /^[\p{L}\s\p{Emoji_Presentation}]*$/u.test(text); // Allows letters, spaces, and emojis
        ...
        <div className="main-content w-4/5 p-6">
            ...
            <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
                ...
                <div className='my-4'>
                    ...
                    />
                    {descriptionError && <p className='text-red-500'>Description should only contain letters, spaces, and emojis.</p>}
                </div>

                <button className='p-2 bg-sky-300 m-8 hover:bg-sky-400 transition-colors duration-300 text-white rounded-lg' onClick={handleSaveVehicle}>
                    Save
                </button>
            </div>
        </div>
