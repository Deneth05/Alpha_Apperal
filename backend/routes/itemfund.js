...
const itemmodel = require("../models/statuesmodel");

const router = express.Router();

router.get("/item_s",async(req,res)=>{
...
router.post("/item_create_s",async(req,res)=>{
...
router.put("/item_update_s",async(req,res)=>{
...
router.delete("/item_delete_s/:id",async(req,res)=>{
...
// router.get("/item_count_s",async(req,res)=>{
//     try{
...
router.get("/item_order_s/:id", async (req, res) => {
    const id = req.params.id;
