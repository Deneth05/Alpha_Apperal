...
import upload from '../multer/multerConfig.js'; // Import multer configuration
...
router.post('/', async (req, res) => {
  ...
  try {
    ...
    // Create an image object with default values if no image is provided
    const newOrder = new Order({
      OrderID,
      CusID,
      Items,
      image: { data: null, contentType: null }, // Default image object
    });
